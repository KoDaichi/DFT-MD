...
! $Id: m_Kpoints.f90,v 1.1.1.1 2004/06/26 11:21:37 yamasaki Exp $
  ...
  real(kind=DP), allocatable, dimension(:)     :: kweight ! weight associated to each k-point
...
!    do i = 1, kv3 * nspin
    do i = 1, kv3
      read(nfinp,*) j, (vkxyz(i,k,CARTS),k=1,3),(vkxyz(i, k, BUCS), k=1,3), kweight(i)
      print *, ' k, kx, ky, kz =', i, (vkxyz(i,k,BUCS),k=1,3)
      print *, ' weight        =', i, kweight(i)
    end do
