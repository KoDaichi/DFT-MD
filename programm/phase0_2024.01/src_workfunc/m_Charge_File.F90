...
contains
  ...
  subroutine m_CF_rd_Header_For_Cube(nfcntn_bin)
    ...
    read(nfcntn_bin) natm2,x_origin,y_origin,z_origin
...
#ifdef DEBUG
    write(0,*) 'fft_param1, cell1',fft_param(1),cell1(1),cell1(2),cell1(3)
    write(0,*) 'fft_param2, cell2',fft_param(2),cell2(1),cell2(2),cell2(3)
    write(0,*) 'fft_param3, cell3',fft_param(3),cell3(1),cell3(2),cell3(3)
#endif
...
#ifdef DEBUG
      write(0,*) iatomtype(i),ival(i),atom_pos(i,1),atom_pos(i,2),atom_pos(i,3)
#endif
    enddo

  end subroutine m_CF_rd_Header_For_Cube

  subroutine m_CF_dealloc()
    deallocate(iatomtype)
    deallocate(ival)
    deallocate(atom_pos)
  end subroutine m_CF_dealloc
